...
1. What problem does the context API help solve?
   Context api helps solving the probelem of state being shared down through a bunch of components, ie prop drilling
2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
   Actions: bring information from the application to store. Reducers: take an action and the state and give a new state in return. Store: the store is where everything is is held, it's where you have your actions, state, and reducers for your entire app.
3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?
   Thunk allows us to have functions that return functions.
4. What is your favorite state management system you've learned and this sprint? Please explain why!
   I like hooks, and I think it's because I feel like I understand hooks and how they work more than I understand the other state management systems. Although I'm using everything we've learned so far in this project, I am most confident about my hook writing abilities. I know that all this means is that I need to work on the other systems more!
